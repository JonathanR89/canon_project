...
function showOnList(placesResults, targetId){
    ...
    for(i=0; i<placesResults.length;i++){
      ...
      if(placesResults[i].photos != null){
        teksLister += '<img src="https://maps.googleapis.com/maps/api/place/photo?maxwidth=50&photoreference='+placesResults[i].photos[0].photo_reference+'&key=AIzaSyBdodiLO598_RD8_NYXK7nBKNA9Fhx_uBQ" width="50">';
      }
